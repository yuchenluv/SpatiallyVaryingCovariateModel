...
Mainly to plot results when using all the stations
...
width = f_width - 180
height = f_height - 60
h1 = point_axis(f_obs[1, 1], "", lonlims, latlims, "", width, height, states_geo, raw_stations, raw_stations[:, :n_obs], :matter, (30, 120), true, true, 15, 15)
cb1 = Colorbar(f_obs[1, 2], h1, label = "record length (years)", height=Relative(85/100), width = 15, ticklabelsize = 15, labelsize = 18, valign=:top);

# save(plotsdir("1d/1raw_data_nobs_all.png"), f_obs);
```
...
width = f_width - 180
height = f_height - 60
h1 = point_axis(f_cor[1, 1], "", lonlims, latlims, "", width, height, states_geo, raw_stations, cor_logCO2[:, 2], :RdBu, (-0.3, 0.3), true, true, 15, 15)
cb1 = Colorbar(f_cor[1, 2], h1, label = "kendall correlation", height=Relative(85/100), width = 15, ticklabelsize = 15, labelsize = 18, valign=:top);

# save(plotsdir("1d/2logCO2_cor.png"), f_cor);
```
...
# save(plotsdir("1d/3quantiles_all_singlePlot.png"), quantile_all_singlePlot)
```
...
# f_trends
save(plotsdir("1d/7p_trend_points.png"), f_trends)
```
...
h3 = point_axis(f_coef[2, 1], "", lonlims, latlims, "scale", width, height, states_geo, raw_stations, logσ_beta_N_mean, :PuOr, (-1.5, 1.5), true, true, xticks_size, yticks_size)
h4 = point_axis(f_coef[2, 2], "", lonlims, latlims, "", width, height, states_geo, raw_stations, logσ_beta_mean, :PuOr, (-1.5, 1.5), true, false, xticks_size, yticks_size)
cb4 = Colorbar(f_coef[2, 3], h4, label = "", height=Relative(82/100), width = 15, ticklabelsize = 20, valign=:top)

# f_coef
# save(plotsdir("1d/6p_coefficients.png"), f_coef)
```
...
# save(plotsdir("1d/8model_comparison_rlmean.png"), p_rl_points_mean)
# save(plotsdir("1d/9model_comparison_rlstd.png"), p_rl_points_std)
```
...
save(plotsdir("1d/10Atlas14_comparison.png"), f_diff)
```
...
### Single location all return level estimate (three models)
...
# Atlas_14_Hou = get_Atlas14_IDF(string(coords_cities[1][2]), string(coords_cities[1][1]))
# Atlas_14_NOLA = get_Atlas14_IDF(string(coords_cities[2][2]), string(coords_cities[2][1]))
# Atlas_14_Gal = get_Atlas14_IDF(string(coords_cities[3][2]), string(coords_cities[3][1]))
# Atlas_14_Mob = get_Atlas14_IDF(string(coords_cities[4][2]), string(coords_cities[4][1]))
...
p_rl_Hou_S = plot_return_period(Atlas_14_Hou, "Pooled Stationary Model", (0, 50), dist_Hou_S, lengend_loc=:topleft, x_label="", y_label=cities_names[1])
p_rl_NOLA_S = plot_return_period(Atlas_14_NOLA, "", (0, 50), dist_NOLA_S, lengend_loc=false, x_label="", y_label=cities_names[2])
p_rl_Gal_S = plot_return_period(Atlas_14_Gal, "", (0, 50), dist_Gal_S, lengend_loc=false, x_label="", y_label=cities_names[3])
p_rl_Mob_S = plot_return_period(Atlas_14_Mob, "", (0, 50), dist_Mob_S, lengend_loc=false, x_label="", y_label=cities_names[4])
...
p_rl_Hou_full = plot_return_period(Atlas_14_Hou, "Spatially Varying Covariate Model", (0, 50), dist_Hou_full, lengend_loc = false, x_label = "", y_label = "")
p_rl_NOLA_full = plot_return_period(Atlas_14_NOLA, "", (0, 50), dist_NOLA_full, lengend_loc = false, x_label = "", y_label = "")
p_rl_Gal_full = plot_return_period(Atlas_14_Gal, "", (0, 50), dist_Gal_full, lengend_loc = false, x_label = "", y_label = "")
p_rl_Mob_full = plot_return_period(Atlas_14_Mob, "", (0, 50), dist_Mob_full, lengend_loc = false, x_label = "", y_label = "");
```
...
p_rl_stations = Plots.plot(
    ...
    p_rl_Gal_S, p_rl_Gal_N, p_rl_Gal_full, 
    p_rl_Mob_S, p_rl_Mob_N, p_rl_Mob_full, 
    layout = layout,
    size = (1800, 1500),
)
