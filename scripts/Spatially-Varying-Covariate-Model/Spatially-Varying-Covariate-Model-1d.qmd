...
# file_path = paste("../../data/processed/1d_results/model_full_", as.character(2), ".Rds", sep = "")
...
```{r}
Model_full_MCMC1 = readRDS("../../data/processed/1d_results/model_full_1.Rds") # subset 1
Model_full_MCMC2 = readRDS("../../data/processed/1d_results/model_full_2.Rds") # subset 2
Model_full_MCMC3 = readRDS("../../data/processed/1d_results/model_full_3.Rds") # subset 3
Model_full_MCMC4 = readRDS("../../data/processed/1d_results/model_full_4.Rds") # subset 4
Model_full_MCMC5 = readRDS("../../data/processed/1d_results/model_full_5.Rds") # subset 5
Model_full_MCMC6 = readRDS("../../data/processed/1d_results/model_full_6.Rds") # all stations
```
...
```{r}
model_full_MCMC_all = c(model_full_MCMC1, model_full_MCMC2, model_full_MCMC3, model_full_MCMC4, model_full_MCMC5, model_full_MCMC6)
...
for (i in 1:6){
  ...
  model_full_MCMC_i = model_full_MCMC_all[i]
  model_full_posterior = matrix(0, nrow = 10000, nc = 7+n_s*4)
  
  for (v in 1:length(variables_full)){
    model_full_posterior[ , i] = unlist(rstan::extract(model_full_MCMC_i, paste(variables_full[v], sep = "")))
  }
  for (s in 1:n_s){
  ...
  file_path = paste("../../data/processed/1d_results/model_full_posterior_sub", as.character(i), ".csv", sep = "")
