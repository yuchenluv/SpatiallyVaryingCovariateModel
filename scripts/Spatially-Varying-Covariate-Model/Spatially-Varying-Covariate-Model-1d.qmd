...
Subset the stations for cross-validation
...
# plot the subsets
pdf("S1_Station_subsets.pdf", width = 8, height = 5)
...
```{r}
# file names: model_full_all_10Kruns, model_full_all_y1_10Kruns, model_full_allS1_10Kruns
pdf("S3_traceplots.pdf", width = 9, height = 6)
Model_full_MCMC = readRDS("../../data/processed/1d_results/model_full_all_50Kruns.Rds") # all stations
Model_full_MCMC
mcmc_trace(Model_full_MCMC, pars = c("mu_rho", "mu_alpha", "logs_rho", "logs_alpha", "mu0_rho", "mu0_alpha", "logs0_rho", "logs0_alpha", "xi"))
dev.off()
# mcmc_trace(Model_full_MCMC, pars = c("mu_rho", "mu_alpha", "logs_rho", "logs_alpha"))
```
...
file_path_MCMC = "../../data/processed/1d_results/model_full_allS5_10Kruns.Rds"
model_full_MCMC_i = readRDS(file_path_MCMC)
# change the station name
n_s = dim(stations5)[1] # n_station
model_full_posterior = matrix(0, nrow = 20000, nc = 9+n_s*4)
...
file_path = "../../data/processed/1d_results/model_full_allS5_10Kruns.csv"
