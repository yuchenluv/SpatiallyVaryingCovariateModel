...
# years_index_all = min(year_prcp):max(year_prcp)
# year1 = years_index_all[seq(1, length(years_index_all), by = 2)]
# year2 = years_index_all[seq(2, length(years_index_all), by = 2)]
years = data[,1]
...
```{r}
Model_full_MCMC = readRDS("../../data/processed/1d_results/model_full_all_4rho_1Mruns.Rds") # all stations
# Model_full_MCMC
# mcmc_trace(Model_full_MCMC, pars = c("mu_rho", "mu_alpha", "logs_rho", "logs_alpha", "mu0_rho", "mu0_alpha", "logs0_rho", "logs0_alpha"))
```
...
file_path_MCMC = "../../data/processed/1d_results/model_full_grids5t1_1Mruns.Rds"
...
file_path = "../../data/processed/1d_results/model_full_grids5t1_1Mruns.csv"
