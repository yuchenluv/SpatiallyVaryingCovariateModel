...
file_path = "../../data/processed/1d_results/model_S_1M.Rds"
...
```{r}
model_S_MCMC = readRDS("../../data/processed/1d_results/model_S_1M.Rds")
model_S_MCMC
```
...
n_s = n_station
model_S_MCMC_i = readRDS("../../data/processed/1d_results/model_S_t1_1M.Rds")
model_S_posterior = matrix(0, nrow = 20000, nc = 5+2*n_s)
...
file_path = "../../data/processed/1d_results/model_S_t1_1M.csv"
