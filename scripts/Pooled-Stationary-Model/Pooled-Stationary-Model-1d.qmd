...
```{r}
model_S_MCMC1 = readRDS("../../data/processed/1d_results/model_S_1.Rds") # subset 1
model_S_MCMC2 = readRDS("../../data/processed/1d_results/model_S_2.Rds") # subset 2
model_S_MCMC3 = readRDS("../../data/processed/1d_results/model_S_3.Rds") # subset 3
model_S_MCMC4 = readRDS("../../data/processed/1d_results/model_S_4.Rds") # subset 4
model_S_MCMC5 = readRDS("../../data/processed/1d_results/model_S_5.Rds") # subset 5
model_S_MCMC6 = readRDS("../../data/processed/1d_results/model_S_6.Rds") # all stations
```
