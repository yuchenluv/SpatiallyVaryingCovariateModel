...
# raw precipiation intensity, missing values as negative
...
lons_grids = [minimum(raw_stations_shuffled.lon), -94.9, -92.8, -90.7, -88.6, maximum(raw_stations_shuffled.lon)]
...
gev_sub1 = hcat([[gev_dist_new(i, log_CO2_2005, raw_stations_shuffled[s, :].lat, raw_stations_shuffled[s, :].lon, x_old_sub1) for i in 1:n_sim] for s in stations_OFS_index]...)
# gev_sub1_18 = [gev_dist_new(i, log_CO2_2005, raw_stations_shuffled[18, :].lat, raw_stations_shuffled[18, :].lon, x_old_sub1) for i in 1:n_sim]
# gev_sub1_22 = [gev_dist_new(i, log_CO2_2005, raw_stations_shuffled[22, :].lat, raw_stations_shuffled[22, :].lon, x_old_sub1) for i in 1:n_sim]
...
rl100_all_boxplot[1:10000, 3] .= 1
rl100_all_boxplot[10001:20000, 1] = [quantile(gev_sub1_18[i][1], 0.99) for i in 1:n_sim]
rl100_all_boxplot[10001:20000, 2] .= 1
rl100_all_boxplot[10001:20000, 3] .= 2

rl100_all_boxplot[20001:30000, 1] = quantile.(gev_all_s22, 0.99)
rl100_all_boxplot[20001:30000, 2] .= 2
rl100_all_boxplot[20001:30000, 3] .= 1
rl100_all_boxplot[30001:40000, 1] = [quantile(gev_sub1_22[i][1], 0.99) for i in 1:n_sim]
rl100_all_boxplot[30001:40000, 2] .= 2
rl100_all_boxplot[30001:40000, 3] .= 2

rl100_all_boxplot[40001:50000, 1] = quantile.(gev_all_s36, 0.99)
rl100_all_boxplot[40001:50000, 2] .= 3
rl100_all_boxplot[40001:50000, 3] .= 1
rl100_all_boxplot[50001:60000, 1] = [quantile(gev_sub1_36[i][1], 0.99) for i in 1:n_sim]
rl100_all_boxplot[50001:60000, 2] .= 3
rl100_all_boxplot[50001:60000, 3] .= 2

rl100_all_boxplot[60001:70000, 1] = quantile.(gev_all_s74, 0.99)
rl100_all_boxplot[60001:70000, 2] .= 4
rl100_all_boxplot[60001:70000, 3] .= 1
rl100_all_boxplot[70001:80000, 1] = [quantile(gev_sub1_74[i][1], 0.99) for i in 1:n_sim]
rl100_all_boxplot[70001:80000, 2] .= 4
rl100_all_boxplot[70001:80000, 3] .= 2

rl100_all_boxplot[80001:90000, 1] = quantile.(gev_all_s104, 0.99)
rl100_all_boxplot[80001:90000, 2] .= 5
rl100_all_boxplot[80001:90000, 3] .= 1
rl100_all_boxplot[90001:100000, 1] = [quantile(gev_sub1_104[i][1], 0.99) for i in 1:n_sim]
rl100_all_boxplot[90001:100000, 2] .= 5
rl100_all_boxplot[90001:100000, 3] .= 2
...
ranges = [(-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30, (-1, 1) .* 30]
